...
event_directory = '../Data/TEST_DATASET'
fn_stations = 'df_stations_merge4a.csv'
...
fn_measure_syn3 = 'df_measure_synchronized_3_a.csv'
fn_output = 'df_measure_merge4a.csv'
...
fname2 = '%s/df_measure_merge4a.csv' % event_directory
fout = '%s/df_measure_grouped_a.csv' % event_directory
...
fdata = '%s/np_waveforms_merge4a.npy' % event_directory
fhypo = '%s/hypo.csv' % event_directory
figdir = '%s/Figures/groups_a' % event_directory
fgrp = '%s/df_groups_a.csv' % event_directory
# dfname = '%s/df_measure_grouped_a.csv' % event_directory
