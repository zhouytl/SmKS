...
event_directory = '../Data/TEST_DATASET'
fn_stations = 'df_stations_merge4c.csv'
...
fn_measure_syn3 = 'df_measure_synchronized_3_c.csv'
fn_output = 'df_measure_merge4c.csv'
...
fname2 = '%s/df_measure_merge4c.csv' % event_directory
fout = '%s/df_measure_grouped_c.csv' % event_directory
add_group_info(fref=fname1, ftarget=fname2, fout=fout)

# %%
from selection_utils import sum_groups_merge4
event_directory = '../Data/TEST_DATASET'
dfname = '%s/df_measure_grouped_c.csv' % event_directory
fdata = '%s/np_waveforms_merge4c.npy' % event_directory
fhypo = '%s/hypo.csv' % event_directory
figdir = '%s/Figures/groups_c' % event_directory
fgrp = '%s/df_groups_c.csv' % event_directory
